...
#define PGN_PROPERTYCHANGE WM_USER + 0x2A  ///<property grid Selection changing notification message
...
#define PropGrid_AddItem(hwndCtl,lpItem) ((int)(DWORD)::SendMessageA((hwndCtl),LB_ADDSTRING,0,(LPARAM)(lpItem)))
