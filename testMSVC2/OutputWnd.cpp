...
int COutputWnd::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	// Create output panes:
	const DWORD dwStyle = ES_MULTILINE | WS_CHILD | WS_VISIBLE | WS_HSCROLL | WS_VSCROLL | ES_READONLY | ES_AUTOVSCROLL;
	if (!m_wndOutput.Create(dwStyle, rectDummy, &m_wndTabs, 2/*TODO::*/))
	{
...
void COutputWnd::AddString(LPCTSTR msg)
{
	//m_wndOutputBuild.AddString(msg);
	m_wndOutput.SetSel(-1, -1);
	m_wndOutput.ReplaceSel(msg);
}
